...
if (isset($_GET[ 'restore_structure' ])) {
    $restore_structure = filter_input(INPUT_GET, 'restore_structure', FILTER_SANITIZE_SPECIAL_CHARS);
}
if (isset($_GET[ 'restore_data' ])) {
    $restore_data = filter_input(INPUT_GET, 'restore_data', FILTER_SANITIZE_SPECIAL_CHARS);
}
if (isset($_POST['replace_url'])) {
    $replace_url =  filter_input(INPUT_POST, 'replace_url', FILTER_SANITIZE_SPECIAL_CHARS);
}
