...
define("_AM_MODULEBACKUP","備莉ｽ模組");
define("_AM_SELECTTABLES","備莉ｽ資料表");
define("_AM_RESTORE","還原");
define("_AM_OPTIMIZE","最佳化");
define("_AM_DETAILSTOBACKUP","選擇備莉ｽ項目");
define("_AM_SELECTMODULE","選擇模組");
define("_AM_COMPRESSION","壓縮");
define("_AM_OTHER","其他");
define("_AM_SELECTAFILE","選擇讙蝿ﾄ");
define("_AM_DETAILSTORESTORE","選擇備莉ｽ項目");
define("_AM_TABLESTRUCTURE","資料表結構");
define("_AM_TABLEDATA","資料表蜈ｧ容");
define("_AM_BACKUP","備莉ｽ");
define("_AM_RESET","重設");
define("_AM_RESTORETITLE","還原");
define("_AM_BACKUPNOTICE","當菴黴按下'備莉ｽ'後，系統將為謔ｨ備莉ｽ所選擇的資料表，並將備莉ｽ讙蝿ﾄ下載到謔ｨ的電腦。");
define("_AM_SELECTTABLE","選擇需備莉ｽ的資料表");
define("_AM_CHECKALL","全選");
define("_AM_RETURNTOSTART","回到backpack首頁");
define("_AM_OPT_WARNING","注意: 最佳化過程中，菴黴將無法存取資料庫");
define("_AM_OPT_STARTING","最佳化資料庫 %s 花費 %s 秒。");
// After V0.86
